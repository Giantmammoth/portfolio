    ...
    <section id="contact" className="py-32 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.p
          ...
          className="text-xl text-text/80 mb-12 leading-relaxed"
        >
        ...
        >
          ...
          <p className="mt-2">{personalInfo.phone}</p>
      ...
      >
        <p>© {new Date().getFullYear()} {personalInfo.name}. {t('contact.footer')}.</p>
      </motion.footer>
    </section>
  );
};
